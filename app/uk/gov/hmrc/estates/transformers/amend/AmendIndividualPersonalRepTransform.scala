...
object AmendIndividualPersonalRepTransform {

  val key = "AmendIndividualPersonalRepTransform"

  implicit val format: Format[AmendIndividualPersonalRepTransform] = Json.format[AmendIndividualPersonalRepTransform]
}
