...
class EstatesStoreConnectorSpec extends BaseConnectorSpec with RecoverMethods {

  private lazy val url: String = "/estates-store/features/5mld"

  private lazy val connector: EstatesStoreConnector = injector.instanceOf[EstatesStoreConnector]
