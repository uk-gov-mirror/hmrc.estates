...
class DesNonMigratedConnectorSpec extends BaseConnectorSpec with JsonRequests {

  lazy val connector: DesNonMigratedConnector = injector.instanceOf[DesNonMigratedConnector]
